...
public class EmailAdapter  extends ArrayAdapter<Names> {

    Context context;
    int resource, textViewResourceId;
    List<Names> items, tempItems, suggestions;

    public EmailAdapter(Context context, int resource, int textViewResourceId, List<Names> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.auto_complete, parent, false);
        }
