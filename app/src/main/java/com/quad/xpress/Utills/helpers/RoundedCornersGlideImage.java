...
/**
 * Created by Venkatesh on 31-05-16.
 */
...
public class RoundedCornersGlideImage implements Transformation<Bitmap> {
    ...
    public RoundedCornersGlideImage(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedCornersGlideImage(BitmapPool pool, int radius, int margin) {
