...
public class PlayListRecords {
    ...
    {
        return "ClassPojo [fileuploadFilename = "+fileuploadFilename+", thumbnailPath = "+thumbnailPath+", likeCount = "+likeCount+", fileuploadPath = "+fileuploadPath+", date = "+date+", feedback = "+feedback+", title = "+title+", _id = "+_id+", from_email = "+from_email+", createdAt = "+createdAt+", thumbnailFilename = "+thumbnailFilename+", tags = "+tags+", created_date = "+created_date+", featuredVideo = "+featuredVideo+", status = "+status+", privacy = "+privacy+", __v = "+__v+", viewed = "+viewed+", country = "+country+", updatedAt = "+updatedAt+", is_deleted = "+is_deleted+", thumbnailmimeType = "+thumbnailmimeType+", filemimeType = "+filemimeType+", language = "+language+", view_count = "+view_count+", to_email = "+to_email+"]";
    }
}