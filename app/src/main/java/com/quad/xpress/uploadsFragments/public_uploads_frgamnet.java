...
import com.quad.xpress.Actvity_video;
...
public class public_uploads_frgamnet extends Fragment implements MyUploadsAdapter.OnRecyclerListener {
    ...
    private void ParsePublicFiles(PlayListResp_emotion arg0) {
        ...
        for (int i = 0; i < RLength; i++) {
            ...
            playlistItems = new PlayListitems_emotion(iii.getFileuploadFilename(), iii.getTitle(), iii.getCreated_date(), iii.getFrom_email()
                    ...
                    sb.toString(),iii.getEmotionCount(),iii.getIsuerfollowing(),iii.getFieldstatus(),iii.getTo_email(),
    ...
    public void onItemClicked(int position) {
        ...
        Intent videoIntent = null;
            ...
            videoIntent    = new Intent(getActivity(),Actvity_video.class);
