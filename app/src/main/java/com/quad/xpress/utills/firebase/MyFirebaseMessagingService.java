...
package com.quad.xpress.utills.firebase;
...
import com.quad.xpress.utills.pushnotification.NotifyUtils;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
           ...
           // image = remoteMessage.getNotification().getIcon();
            timestamp = ""+remoteMessage.getSentTime();
            Log.d("fbas",remoteMessage.getNotification().toString());
            ...
            if(message != null) {
                ...
                if (message.contains("Rise up to") || message.contains("Accepted")) {
                    ...
                    showNotificationMessage(getApplicationContext(),  ""+title, ""+message, timestamp, acceptedRejectIntent);

                } else if (message.contains("latest Xpression")) {

                    showNotificationMessage(getApplicationContext(),  ""+title, ""+message, timestamp, followerIntent);
                } else {

                    showNotificationMessage(getApplicationContext(),  ""+title, ""+message, timestamp, newMessageIntent);
                }
            }else{
                showNotificationMessage(getApplicationContext(), ""+title , ""+message, timestamp, acceptedRejectIntent);
            }
